 ...
 *
 * همهٔ اسپرایت‌ها روی یک بوم ۴۲۰×۵۶۰ با لنگر «پایین-وسط» رندر شده‌اند، پس نسبت
 * ابعاد همهٔ فریم‌های همهٔ شخصیت‌ها دقیقاً یکسان است و برای جاگذاری فقط کافی است
...
object RoomChars {
    ...
    /** نسبت عرض به ارتفاع بوم اسپرایت‌ها (۴۲۰ ÷ ۵۶۰). */
