 ...
 *  ذخیره در گالری (Pictures/Shadbib) با MediaStore. */
object ReportImage {
        ...
        return try {
            ...
            if (Build.VERSION.SDK_INT >= 29) {
                val values = ContentValues().apply {
                    ...
                    put(MediaStore.Images.Media.RELATIVE_PATH, Environment.DIRECTORY_PICTURES + "/Shadbib")
                }
                ...
                val dir = File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES), "Shadbib")
